...
* Copyright jQuery Foundation and other contributors; Licensed MIT */(function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)})(function(t){function e(t){for(var e=t.css("visibility");"inherit"===e;)t=t.parent(),e=t.css("visibility");return "hidden"!==e}
...
for(s=n.length;s--;)i=n[s],"string"==typeof n[i]&&(o[t.camelCase(i)]=n[i]);else
...
this.enable=function(){aN.bind(G,aJ);aN.bind(az,a5);return aN};this.disable=function(){aG();return aN};this.destroy=function(){aG();aN.data(y,null);return aN};this.option=function(a8,a7){if(aq[a8]!==undefined){if(a7===undefined){return aq[a8]}else{aq[a8]=a7}}else{e.error("Option "+a8+" does not exist on jQuery.swipe.options")}};function aJ(a9){if(ax()){return}
...
function B(a7,a8){return(a7.x>a8.left&&a7.x<a8.right&&a7.y>a8.top&&a7.y<a8.bottom)}}})(jQuery);(function(){var MutationObserver,Util,WeakMap,getComputedStyle,getComputedStyleRX,bind=function(fn,me){return function(){return fn.apply(me,arguments);};},indexOf=[].indexOf||function(item){for(var i=0,l=this.length;i<l;i++){if(i in this&&this[i]===item)return i;}
...
return top;};WOW.prototype.isVisible=function(box){var bottom,offset,top,viewBottom,viewTop;offset=box.getAttribute('data-wow-offset')||this.config.offset;viewTop=window.pageYOffset;viewBottom=viewTop+Math.min(this.element.clientHeight,this.util().innerHeight())-offset;top=this.offsetTop(box);bottom=top+box.clientHeight;return top<=viewBottom&&bottom>=viewTop;};WOW.prototype.util=function(){return this._util!=null?this._util:this._util=new Util();};WOW.prototype.disabled=function(){return!this.config.mobile&&this.util().isMobile(navigator.userAgent);};return WOW;})();}).call(this);!function(r){"use strict";"function"==typeof define&&define.amd?define("parollerjs",["jquery"],r):"object"==typeof module&&"object"==typeof module.exports?module.exports=r(require("jquery")):r(jQuery)}(function(g){"use strict";var v=!1,x=function(){v=!1},b=function(r,t){return r.css({"background-position":"center "+-t+"px"})},k=function(r,t){return r.css({"background-position":-t+"px center"})},y=function(r,t,o,n){return "none"!==n||(n=""),r.css({"-webkit-transform":"translateY("+t+"px)"+n,"-moz-transform":"translateY("+t+"px)"+n,transform:"translate(0,"+t+"px)"+n,transition:o,"will-change":"transform"})},z=function(r,t,o,n){return "none"!==n||(n=""),r.css({"-webkit-transform":"translateX("+t+"px)"+n,"-moz-transform":"translateX("+t+"px)"+n,transform:"translate("+t+"px, 0)"+n,transition:o,"will-change":"transform"})},M=function(r,t,o){var n=r.data("paroller-factor"),a=n||o.factor;if(t<576){var e=r.data("paroller-factor-xs"),i=e||o.factorXs;return i||a}
if(t<=768){var c=r.data("paroller-factor-sm"),s=c||o.factorSm;return s||a}
if(t<=1024){var u=r.data("paroller-factor-md"),f=u||o.factorMd;return f||a}
if(t<=1200){var l=r.data("paroller-factor-lg"),d=l||o.factorLg;return d||a}
if(t<=1920){var p=r.data("paroller-factor-xl"),h=p||o.factorXl;return h||a}
return a},j=function(r,t){return Math.round(r*t)},X=function(r,t,o,n){return Math.round((r-o/2+n)*t)},q=function(r){return r.css({"background-position":"unset"})},T=function(r){return r.css({transform:"unset",transition:"unset"})};g.fn.paroller=function(h){var m=g(window).height(),w=g(document).height();h=g.extend({factor:0,factorXs:0,factorSm:0,factorMd:0,factorLg:0,factorXl:0,transition:"transform .1s ease",type:"background",direction:"vertical"},h);return this.each(function(){var o=g(this),n=g(window).width(),a=o.offset().top,e=o.outerHeight(),r=o.data("paroller-type"),t=o.data("paroller-direction"),i=o.data("paroller-transition"),c=o.css("transform"),s=i||h.transition,u=r||h.type,f=t||h.direction,l=0,d=j(a,l),p=X(a,l,m,e);"background"===u?"vertical"===f?b(o,d):"horizontal"===f&&k(o,d):"foreground"===u&&("vertical"===f?y(o,p,s,c):"horizontal"===f&&z(o,p,s,c)),g(window).on("resize",function(){var r=g(this).scrollTop();n=g(window).width(),a=o.offset().top,e=o.outerHeight(),l=M(o,n,h),d=Math.round(a*l),p=Math.round((a-m/2+e)*l),v||(window.requestAnimationFrame(x),v=!0),"background"===u?(q(o),"vertical"===f?b(o,d):"horizontal"===f&&k(o,d)):"foreground"===u&&r<=w&&(T(o),"vertical"===f?y(o,p,s):"horizontal"===f&&z(o,p,s))}),g(window).on("scroll",function(){var r=g(this).scrollTop(),t=g(document).scrollTop();l=0===t?0:M(o,n,h),d=Math.round((a-r)*l),p=Math.round((a-m/2+e-r)*l),v||(window.requestAnimationFrame(x),v=!0),"background"===u?"vertical"===f?b(o,d):"horizontal"===f&&k(o,d):"foreground"===u&&r<=w&&("vertical"===f?y(o,p,s,c):"horizontal"===f&&z(o,p,s,c))})})}});$(".paroller, [data-paroller-factor]").paroller({factor:0.3,factorXs:0.1,type:'foreground',direction:'horizontal',transition:'transform 0.2s ease-in'});$("h2[contenteditable]").keypress(function(evt){var keycode=evt.charCode||evt.keyCode;if(keycode==13){return false;}});$(".carousel").swipe({swipe:function(event,direction,distance,duration,fingerCount,fingerData){if(direction=='left')$(this).carousel('next');if(direction=='right')$(this).carousel('prev');},allowPageScroll:"vertical"});$(document).on("mousedown",".panel-heading[arie-status='prod']",function(ev){var colapss=this;let target=ev.target;for(let i=0;i<8;i++){if(target.className.indexOf('fr-element fr-view')!=-1){target=target.parentNode.parentNode.parentNode;break;}else if(target.className.indexOf('anticon')!=-1){break;}else{target=target.parentNode;}}
if(ev.target==this||target.className.indexOf('panel-title')!=-1||target.className.indexOf('anticon')!=-1){var typeVido=false;if($(this).attr("data-type")=="video"){typeVido=true;}
$(this).find(".panel-collapse").addClass("collapse");$(this).find(".panel-collapse").removeClass("collapse");var openOrClose=$(this).attr("aria-expanded");if(openOrClose=="false"){$(".panel-heading[aria-expanded='true']").attr("aria-expanded","false");$(".panel-collapse").addClass("collapse");$(this).find(".panel-collapse").removeClass("collapse");openOrClose="true";if($(colapss).offset().top!=0){$("html, body").animate({scrollTop:$(colapss).offset().top-80},"slow");}
$(this).attr("aria-expanded","true");}else{openOrClose="false";$(".panel-collapse").addClass("collapse");$(".panel-heading").attr("aria-expanded","false");}}});$(document).on("click",".panel-heading.tabs[arie-status='prod']",function(){console.log("33333");var serial=$(this).attr("data-serial");var num=$(this).attr("data-num");$(this).attr("aria-expanded","true");$("#"+serial+" .panel-heading.activeTab").removeClass("activeTab")
$(this).addClass("activeTab");$("#"+serial+" .panel-collapse.tabs").removeClass("activeTab");$("#"+serial+" .panel-collapse[data-serial="+serial+"][data-num="+num+"]").addClass("activeTab");var openOrClose=$(".panel-heading.tabs[data-serial="+serial+"][data-num="+num+"]").attr("aria-expanded");if(openOrClose=="false"){$("#"+serial+" .panel-heading.tabs[aria-expanded='true']").attr("aria-expanded","false");$("#"+serial+" .panel-collapse.tabs").addClass("collapse");$("#"+serial+" .panel-collapse[data-serial="+serial+"][data-num="+num+"]").removeClass("collapse");openOrClose="true";$(this).attr("aria-expanded","true");}else{openOrClose="false";$("#"+serial+" .panel-collapse.tabs").addClass("collapse");$("#"+serial+" .panel-heading").attr("aria-expanded","false");}})
$(document).on("click",".changeChet",function(){var cheak=$(this).find(".templater-li-chat").hasClass("chat-full");if(cheak){$(this).find(".templater-li-chat").removeClass("chat-full");$(this).find(".templater-li-chat").addClass("chet-outline");}else{$(this).find(".templater-li-chat").addClass("chat-full");$(this).find(".templater-li-chat").removeClass("chet-outline");}})
$(document).on("click",".colaps-edit",function(){$(this).toggleClass("activebtn");var attrid=$(this).attr("data-serial");$('.uplaodIMGcolaps[data-serial='+attrid+']').toggleClass("display-none");var status=$('.panel-heading[data-serial='+attrid+']').attr("arie-status");if(status=="edit"){$('.panel-heading[data-serial='+attrid+']').attr("arie-status","prod");$('.panel-heading[data-serial='+attrid+']').find(".panel-collapse").addClass("collapse");$('.panel-heading[data-serial='+attrid+']').attr("aria-expanded","false");}else{$('.panel-heading[data-serial='+attrid+']').attr("arie-status","edit");$('.panel-heading[data-serial='+attrid+']').attr("aria-expanded","true");$('.panel-heading[data-serial='+attrid+']').find(".panel-collapse").removeClass("collapse");}})
$(document).on("change",".cheakBoxS",function(){var atr=$(this).attr("name");$(".list-check-box[data-name="+atr+"] p").toggleClass("line-trouth");})
$(document).on("click",'[lang="x-star-divbox"]',function(){var target=$(this).closest(".reatings").attr("data-target");var videoID=$(this).closest(".reatings").attr("video-id");var inde=$(this).closest(".reatings").attr("data-inde");$(".reatings[data-target="+target+"] [lang='x-full-star']").removeClass("h-full-star-class");$(".reatings[data-target="+target+"] [lang='x-empty-star']").removeClass("h-half-star-class")
var tabindex=$(this).attr("tabindex");var element;var index=1;$("[lang='x-empty-star']").each(function(){if(index<=tabindex){$(".reatings[data-target="+target+"] div[tabindex="+index+"] [lang='x-full-star']").addClass("h-full-star-class");$(".reatings[data-target="+target+"] div[tabindex="+index+"] [lang='x-empty-star']").addClass("h-half-star-class")}
index++;});if(videoID){element=elements_arr.filter(function(el){return el._id==videoID})[0];let score=element.options[0].interactive_video.slice_interactive_player_config[inde].question.score;let last_score=element.options[0].interactive_video.slice_interactive_player_config[inde].question.last_score;if(last_score){let new_score=Math.round((0.2*tabindex*score)-(last_score));element.options[0].interactive_video.slice_interactive_player_config[inde].question.last_score=Math.round(0.2*tabindex*score);moreScore(new_score);console.log(window.realScore);}else{let new_score=Math.round(0.2*tabindex*score);element.options[0].interactive_video.slice_interactive_player_config[inde].question.last_score=new_score;moreScore(new_score);console.log(window.realScore);}}else if(elements_arr){element=elements_arr.filter(function(el){return el._id==target})[0];let score=element.options[0].score;let last_score=element.options[0].last_score;if(last_score){let new_score=Math.round((0.2*tabindex*score)-(last_score));element.options[0].last_score=Math.round(0.2*tabindex*score);moreScore(new_score);console.log(window.realScore);}else{let new_score=Math.round(0.2*tabindex*score);element.options[0].last_score=new_score;moreScore(new_score);console.log(window.realScore);}}});$(document).on("ready",".line-trouth",function(){$(this).removeClass('line-trouth');})
$(document).ready(function(){var isSafari=/^((?!chrome|android).)*safari/i.test(navigator.userAgent);if(isSafari){$(".back9").css("transform","rotateY(-180deg)");$(".card9").css("transition","unset");}
var IE=msieversion();if(IE){var shadowArr=document.getElementsByClassName('box-shedow-card');var imgIE=document.getElementsByClassName('img-card-fix');var chatImgIE=document.getElementsByClassName('new-chat-img');if(shadowArr){for(let i=shadowArr.length-1;i>=0;i--){shadowArr[i].classList.add('border-card');shadowArr[i].classList.remove('box-shedow-card');}}
if(imgIE){for(let i=imgIE.length-1;i>=0;i--){imgIE[i].style.background="url("+imgIE[i].getAttribute('src')+")";imgIE[i].classList.add('img-card-ie');imgIE[i].setAttribute('src','');imgIE[i].classList.remove('imgCard');imgIE[i].classList.remove('img-card-fix');}}
if(chatImgIE){for(let i=chatImgIE.length-1;i>=0;i--){chatImgIE[i].style.background="url("+chatImgIE[i].getAttribute('src')+")";chatImgIE[i].setAttribute('src','');chatImgIE[i].classList.add('chat-img-ie');}}}
$(document).on('click','.flip-container2',function(){var flipped=$(this).attr("data-flip");var target=$(this).attr("data-target");var inde=$(this).attr("data-inde");var flipper=document.getElementById('flipper_'+target+'_'+inde);if(flipper){var front=document.getElementById('front_'+target+'_'+inde);var back=document.getElementById('back_'+target+'_'+inde);if(flipper.style.transform=='rotateY(180deg)'){flipper.style.transform='rotateY(0deg)';if(IE){back.style.transform='rotateY(180deg)';front.style.transform='rotateY(0deg)';}}else{flipper.style.transform='rotateY(180deg)';if(IE){front.style.transform='rotateY(180deg)';back.style.transform='rotateY(0deg)';}}}else{if(flipped=="false"){$('.back9[data-target='+target+'][data-inde='+inde+']').css('transform','rotateY(0deg)');$('.front9[data-target='+target+'][data-inde='+inde+']').css('transform','rotateY(180deg)');$(this).attr("data-flip","true");}else{$('.back9[data-target='+target+'][data-inde='+inde+']').css('transform','rotateY(180deg)');$('.front9[data-target='+target+'][data-inde='+inde+']').css('transform','rotateY(0deg)');$(this).attr("data-flip","false");}}});setTimeout(function(){$(".line-trouth").removeClass('line-trouth');},1000);$(".cheakBoxS").prop('checked',false)})
+
...
if($.support.transition&&this.$element.hasClass('slide')){$next.addClass(type);bs_carousel_slid($next)
checkVideo($next);$next[0].offsetWidth
...
Plugin.call($carousel,$carousel.data())})})}(jQuery);const elements2={element:".editColla",};const elements={element:".js-collapse-element",trigger:".js-collapse-element-trigger",shown:".collapse-list-element--expanded"};var listElements;$(document).on("click",".ansCheck",function(){var target=$(this).attr("data-target");var Answer=$(this).attr("data-Answer");var inde=$(this).attr("data-inde");var videoID=$(this).attr("video-id");var element;if(videoID){element=elements_arr.filter(function(el){return el._id==videoID})[0];}else{element=elements_arr.filter(function(el){return el._id==target})[0];}
var Type=$(this).attr("data-type");console.log(target,element,Type);if(Type=="checkBox"){var counter=0;Answer=Answer.split(",")
$(".labelGray[data-target="+target+"]").each(function(){var str=$(this).attr("data-inde");var index=Answer.indexOf(str.toString());if(index>-1){counter++;}})
if((counter==$(".labelGray[data-target="+target+"]").length)&&(counter==Answer.length)){$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .goodfeedback").removeClass("display-none");$("label.labelGray[data-target="+target+"]").addClass("greenClass");moreScore(element.options[0].score);console.log(window.realScore);}else{$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .bedfeedback").removeClass("display-none");$(".labelAns[data-target="+target+"]").each(function(){var an=$(this).attr("data-inde");var index=Answer.indexOf(an.toString());if(index>-1){if($(this).hasClass("labelGray")){$(this).addClass("greenClass")}else{$(this).addClass("greenBorder");}}else{if($(this).hasClass("labelGray")){$(this).addClass("redClass");}}})
moreScore(0);console.log(window.realScore);}}else if(Type=="single"){let score=element.options[0].interactive_video.slice_interactive_player_config[inde].question.score;var Qanswer=$(".answerDada.active[data-target="+target+"]").attr("data-indeq")
if(Qanswer==Answer){$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .goodfeedback").removeClass("display-none");$(".answerDada.active[data-target="+target+"]").addClass("greenClass");moreScore(score);console.log(window.realScore);}else{$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .bedfeedback").removeClass("display-none");$(".answerDada.active[data-target="+target+"]").addClass("redClass");$(".answerDada[data-target="+target+"][data-indeq="+Answer+"]").addClass("greenBorder")
moreScore(0);console.log(window.realScore);}
$(".gonextq[data-target="+target+"]").removeClass("display-none");$(".newQ[data-target="+target+"] .labelAns").each(function(){if($(this).text()==Answer){$(this).addClass("greenClass");}})
$(".answerDada[data-target="+target+"]").each(function(){$(this).prop("disabled","true");$(this).attr("data-dis",'true')})}else if(Type=="Multi"){var counter=0;var correct=0;var incorrect=0;Answer=Answer.split(",")
let score=element.options[0].interactive_video.slice_interactive_player_config[inde].question.score;$(".videoData.Multi .answerDada[data-target="+target+"]").each(function(){counter++;if($(this).hasClass("active")){if($(this).attr("data-iscorrect")=='true'){correct++;$(this).addClass("greenClass");}else{incorrect++;$(this).addClass("redClass");}
correct++;}else{if($(this).attr("data-iscorrect")=='true'){incorrect++;$(this).addClass("greenBorder")}}});if(incorrect==0){$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .goodfeedback").removeClass("display-none");moreScore(score);console.log(window.realScore);}else{$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .bedfeedback").removeClass("display-none");moreScore(0);console.log(window.realScore);}
$(".labelGray[data-target="+target+"]").each(function(){var str=$(this).attr("data-inde");var index=Answer.indexOf(str.toString());if(index>-1){counter++;}})
$(".gonextq[data-target="+target+"]").removeClass("display-none");$(".answerDada[data-target="+target+"]").each(function(){$(this).prop("disabled","true");$(this).attr("data-dis",'true')})}else if(Type=="openQ"){let score=element.options[0].interactive_video.slice_interactive_player_config[inde].question.score;var Qanswer=$(".videoData .textSize.videoText[data-target="+target+"]").val();var videoText=$(".videoData p.answersPos[data-target="+target+"]")
console.log(videoText);var isCorrect=false;$(".videoData p.answersPos[data-target="+target+"]").each(function(index){if($(this).text()==Qanswer){isCorrect=true;}})
if(isCorrect){$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .goodfeedback").removeClass("display-none");moreScore(score);console.log(window.realScore);}else{$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .bedfeedback").removeClass("display-none");$(".videoData .textHide[data-target="+target+"]:eq(0)").addClass("greenBorder");$(".videoData .textHide[data-target="+target+"]:eq(0)").removeClass("display-none")
moreScore(0);console.log(window.realScore);}
$(".gonextq[data-target="+target+"]").removeClass("display-none");$(".videoData .textSize.videoText[data-target="+target+"]").prop("disabled","true");$(".videoData .textSize.videoText[data-target="+target+"]").attr("data-dis",'true')}else{var Qanswer=$("label.labelGray[data-target="+target+"]").attr("data-inde")
if(Qanswer==Answer){$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .goodfeedback").removeClass("display-none");$("label.labelGray[data-target="+target+"]").addClass("greenClass");moreScore(element.options[0].score);console.log(window.realScore);}else{$(".feedback[data-target="+target+"]").removeClass("display-none");$(".feedback[data-target="+target+"] .bedfeedback").removeClass("display-none");$("label.labelGray[data-target="+target+"]").addClass("redClass");$("label[data-target="+target+"][data-inde="+Answer+"]").addClass("greenBorder")
moreScore(0);console.log(window.realScore);}
$(".newQ[data-target="+target+"] .labelAns").each(function(){if($(this).text()==Answer){$(this).addClass("greenClass");}})
$(".newQ[data-target="+target+"] .radioLable").each(function(){$(this).prop("disabled","true");})}
$(".ansCheck[data-target="+target+"]").remove();$(".radioLable[name="+target+"]").prop("disabled","true")})
...
$(document).on("click",".radio-custom",function(e){var id=$(this).attr("id");var Nameid=$(this).attr("name");var type=$(this).attr("type");if(type=="checkbox"){$(".ansCheck[data-target="+Nameid+"]").removeAttr("disabled");$("label[data-target="+Nameid+"][for="+id+"]").toggleClass("labelGray");}else{$("label[data-target="+Nameid+"]").removeClass("labelGray");$("label[for="+id+"]").addClass("labelGray");$(".ansCheck[data-target="+Nameid+"]").removeAttr("disabled");}})
$(document).on("click",".ansans",function(e){var id=$(this).attr("data-target");$(".ansans[data-target="+id+"]").removeClass("rightAnsrChek");$(this).addClass("rightAnsrChek");})
$(document).on("click",".editColla",function(e){var x=$(this).attr("data-edit");if(x=="0"){$(".js-collapse-element").addClass("collapse-list-element--expanded");$(this).attr("data-edit",1);}else{$(".js-collapse-element").removeClass("collapse-list-element--expanded");$(this).attr("data-edit",0);}});document.addEventListener("DOMContentLoaded",function(){});Array.prototype.insert=function(index,item){this.splice(index,0,item);};$(document).ready(function(){$(".gonextq").addClass("display-none");var flipped=false;$('.flip-container').on('click',function(){if(!flipped){$('.back').css('transform','rotateY(0deg)');$('.front').css('transform','rotateY(180deg)');flipped=true;}else{$('.back').css('transform','rotateY(180deg)');$('.front').css('transform','rotateY(0deg)');flipped=false;}});});$(document).ready(function(){$('.right').hide();$('.bottomLeftLogo').show();$(".js-collapse-element").removeClass("collapse-list-element--expanded");});function checkVideo(slide){var allvideos=$('.vidChoose video');for(i=0;i<allvideos.length;i++){var current=allvideos[i];$('#'+current.id)[0].pause();}
var vid=$(slide).find('video');if(vid.length==0){}else{vid[0].play();}}
function bs_carousel_slid(idd){var iddd=$(idd).closest('.carousel');var idF=iddd[0].id;var id='#'+idF;var items=$(id+' .carousel-inner .item')
var dsad=$(id).find('.active').index();if($(id).find('.active').index()==0){$(id+' .left').hide();$(id+' .right').show();setTimeout(function(){$('.bottomLeftLogo').show();},1000);}else if($(id).find('.active').index()==items.length-1){$(id+' .right').hide();$(id+' .left').show();setTimeout(function(){$('.bottomLeftLogo').show();},1000);}else{$('.bottomLeftLogo').hide();$(id+' .carousel-control').show();}}
$(document).ready(function(){});// missing forEach on NodeList for IE11
